...
@Component({
  selector: 'app-modal-siabono-intercambio',
  templateUrl: './modal-siabono-intercambio.component.html',
  styleUrls: ['./modal-siabono-intercambio.component.css']
})
export class ModalSiabonoIntercambioComponent implements OnInit {
