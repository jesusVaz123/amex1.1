...
@Component({
  selector: 'app-modal-soloinyectar',
  templateUrl: './modal-soloinyectar.component.html',
  styleUrls: ['./modal-soloinyectar.component.css']
})
export class ModalSoloinyectarComponent implements OnInit {
